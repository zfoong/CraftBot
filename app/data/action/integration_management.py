...
def list_available_integrations(input_data: dict) -> dict:
    ...
    try:
        from app.external_comms.integration_settings import list_integrations
...
def check_integration_status(input_data: dict) -> dict:
    ...
    try:
        ...
        if session_id and integration_id == "whatsapp":
            from app.external_comms.integration_settings import check_whatsapp_session_status
        ...
        from app.external_comms.integration_settings import get_integration_info
...
def disconnect_integration(input_data: dict) -> dict:
    ...
    try:
        from app.external_comms.integration_settings import disconnect_integration as _disconnect
