...
async def get_jira_issue(input_data: dict) -> dict:
    try:
        ...
        fields_str = input_data.get("fields", "")
        fields_list = [f.strip() for f in fields_str.split(",") if f.strip()] if fields_str else None
        result = await client.get_issue(input_data["issue_key"], fields_list=fields_list)
        return {"status": "success", "result": result}
    except Exception as e:
        return {"status": "error", "message": str(e)}
...
async def update_jira_issue(input_data: dict) -> dict:
    try:
        ...
        if input_data.get("labels"):
            fields_update["labels"] = [l.strip() for l in input_data["labels"].split(",") if l.strip()]
        if not fields_update:
            return {"status": "error", "message": "No fields to update."}
        result = await client.update_issue(input_data["issue_key"], fields_update)
        return {"status": "success", "result": result}
    except Exception as e:
        return {"status": "error", "message": str(e)}
...
async def add_jira_comment(input_data: dict) -> dict:
    try:
        ...
        if not client.has_credentials():
            return {"status": "error", "message": _NO_CRED_MSG}
        result = await client.add_comment(input_data["issue_key"], input_data["body"])
        return {"status": "success", "result": result}
    except Exception as e:
        return {"status": "error", "message": str(e)}
...
async def get_jira_transitions(input_data: dict) -> dict:
    try:
        ...
        if not client.has_credentials():
            return {"status": "error", "message": _NO_CRED_MSG}
        result = await client.get_transitions(input_data["issue_key"])
        return {"status": "success", "result": result}
    except Exception as e:
        return {"status": "error", "message": str(e)}
...
async def add_jira_labels(input_data: dict) -> dict:
    try:
        ...
        result = await client.add_labels(input_data["issue_key"], labels)
        return {"status": "success", "result": result}
    except Exception as e:
        return {"status": "error", "message": str(e)}
...
async def remove_jira_labels(input_data: dict) -> dict:
    try:
        ...
        if not labels:
            return {"status": "error", "message": "No labels provided."}
        result = await client.remove_labels(input_data["issue_key"], labels)
        return {"status": "success", "result": result}
    except Exception as e:
        return {"status": "error", "message": str(e)}
...
async def list_jira_projects(input_data: dict) -> dict:
    try:
        ...
        if not client.has_credentials():
            return {"status": "error", "message": _NO_CRED_MSG}
        result = await client.get_projects(max_results=input_data.get("max_results", 50))
        return {"status": "success", "result": result}
    except Exception as e:
        return {"status": "error", "message": str(e)}
