...
_NO_CRED_MSG = "No Twitter/X credential. Use /twitter login first."
...
async def post_tweet(input_data: dict) -> dict:
    try:
        from app.external_comms.platforms.twitter import TwitterClient
        client = TwitterClient()
        if not client.has_credentials():
            return {"status": "error", "message": _NO_CRED_MSG}
        result = await client.post_tweet(input_data["text"], reply_to=input_data.get("reply_to") or None)
...
async def reply_to_tweet(input_data: dict) -> dict:
    try:
        ...
        if not client.has_credentials():
            return {"status": "error", "message": _NO_CRED_MSG}
        result = await client.reply_to_tweet(input_data["tweet_id"], input_data["text"])
        return {"status": "success", "result": result}
    except Exception as e:
        return {"status": "error", "message": str(e)}
...
async def delete_tweet(input_data: dict) -> dict:
    try:
        ...
        if not client.has_credentials():
            return {"status": "error", "message": _NO_CRED_MSG}
        result = await client.delete_tweet(input_data["tweet_id"])
        return {"status": "success", "result": result}
    except Exception as e:
        return {"status": "error", "message": str(e)}
...
async def search_tweets(input_data: dict) -> dict:
    try:
        ...
        if not client.has_credentials():
            return {"status": "error", "message": _NO_CRED_MSG}
        result = await client.search_tweets(input_data["query"], max_results=input_data.get("max_results", 10))
        return {"status": "success", "result": result}
    except Exception as e:
        return {"status": "error", "message": str(e)}
...
async def get_twitter_timeline(input_data: dict) -> dict:
    try:
        ...
        if not client.has_credentials():
            return {"status": "error", "message": _NO_CRED_MSG}
        result = await client.get_user_timeline(
...
async def like_tweet(input_data: dict) -> dict:
    try:
        ...
        if not client.has_credentials():
            return {"status": "error", "message": _NO_CRED_MSG}
        result = await client.like_tweet(input_data["tweet_id"])
        return {"status": "success", "result": result}
    except Exception as e:
        return {"status": "error", "message": str(e)}
...
async def retweet(input_data: dict) -> dict:
    try:
        ...
        if not client.has_credentials():
            return {"status": "error", "message": _NO_CRED_MSG}
        result = await client.retweet(input_data["tweet_id"])
        return {"status": "success", "result": result}
    except Exception as e:
        return {"status": "error", "message": str(e)}
...
async def get_twitter_user(input_data: dict) -> dict:
    try:
        ...
        if not client.has_credentials():
            return {"status": "error", "message": _NO_CRED_MSG}
        result = await client.get_user_by_username(input_data["username"])
        return {"status": "success", "result": result}
    except Exception as e:
        return {"status": "error", "message": str(e)}
